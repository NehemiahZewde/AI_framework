...
Milestone: M2 - Healthcare Dataset Catalog Tool
Version: 0.2.0
...
OpenWebUI can discover this tool through the automatically generated
OpenAPI schema at:
...
1. Direct framework self-test:
       ...
       python ai_framework_openapi_server_v0_2_catalog.py --self-test

2. Start the OpenAPI server:

       python ai_framework_openapi_server_v0_2_catalog.py

OpenWebUI connection
--------------------
OpenWebUI running in Docker should use this API Base URL:
