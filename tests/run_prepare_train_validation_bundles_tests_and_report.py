# MILESTONE 6 - DIRECT ML_TRAIN_VALIDATION TEST RUNNER - VERSION 1
# Tests ai_framework.ml_train_validation.prepare_train_validation_bundles directly.
# Expected contract: 42 tests, 42 passes, 0 known gaps.
# Generated report: prepare_train_validation_bundles_detailed_report.txt
...
import ai_framework.ml_train_validation as mlv
...
def _prepare(X, y, **kwargs):
    ...
    return mlv.prepare_train_validation_bundles(
        X=X,
        y=y,
